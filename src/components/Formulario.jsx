...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  /** RECUERDA LAS SIGUIENTES REGLAS PARA LOS HOOKS: 1.-NO PUEDEN IR POR FUERA DEL COMPONENTE, TIENEN QUE IR INMEDIATAMENTE DESPUES DE QUE FUE DECLARADA LA FUNCION. 2.-NO SE PUEDEN REGISTRAR DE FORMA CONDICIONAL. 3.-NO SE PUEDEN DECLARAR DESPUES DE UN RETURN.
   **/
  ...
  const handleSubmit = (e) => {
    ...
    const objetoPaciente = {
      //Este es elobjeto en memoria de lo que leemos en el formulario
      nombre,
      propietario,
      email,
      fecha,
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-3 mb-6">
      ...
      <form
        ...
        className="bg-rose-50 shadow-md rounded-lg py-10 px-5 mb-10 border-2 border-rose-300"
      >
        {error && (
          <Error>
      ...
      <p className="font-semibold text-xl text-center text-neutral-600">
        Created By Jonathan Morales with{" "}
        <span className="text-2xl text-teal-500">React JS</span>
      </p>
    </div>
  );
};
